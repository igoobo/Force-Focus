...
async def analyze_session_insight(
    ...
    if is_data_insufficient:
        ...
        4. **영문 배지**: 성과에 따라 'DEEP WORK', 'GOAL ACHIEVED', 'DISTRACTED', 'RECOVERY NEEDED' 등 상황에 맞는 영문 배지를 부여하세요.
        ...
        6. **텍스트 강조**: 특정 앱 이름, 시간대, 점유율 수치는 반드시 **볼드체**(**내용**)로 표기하세요.

        7. 모든 응답은 InsightResponse JSON 구조를 엄격히 따르며, 한국어로 친절하고 전문적인 코치로서의 톤을 유지하세요.
        """
